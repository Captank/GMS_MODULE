...
CREATE TABLE IF NOT EXISTS `gms_item_data` ( `lowid` int(11) NOT NULL DEFAULT '0', `highid` int(11) DEFAULT NULL, `icon` int(11) DEFAULT NULL, `name` VARCHAR(150) DEFAULT NULL `category` int(11) NOT NULL, PRIMARY KEY (`lowid`));
